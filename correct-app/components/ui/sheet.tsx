...
const sheetVariants = cva(
	'fixed z-50 gap-4 bg-background p-3 md:p-6  transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
	{
		variants: {
			side: {
...
>(
	(
		{ side = 'right', className, children, hideCloseIcon = false, ...props },
		ref
	) => (
		<SheetPortal>
			<SheetOverlay />
...
>(({ className, ...props }, ref) => (
	<SheetPrimitive.Description
		ref={ref}
		className={cn('text-sm text-secondarygray-dark', className)}
		{...props}
	/>
));
