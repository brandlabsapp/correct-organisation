...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex h-12 w-full items-center text-black justify-between whitespace-nowrap rounded-md border border-secondarygray bg-transparent px-3 py-2 text-sm shadow-sm ring-secondarygray placeholder:text-secondarygray focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
			className
		)}
		{...props}
	>
